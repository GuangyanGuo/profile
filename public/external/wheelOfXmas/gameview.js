...
//---------------------------------------------------------------------
	function StatePlayNow()
	{
		...
		if (gameModel.orient == gameModel.VERTICAL)	{
			...
			var _homeSprite = createSprite("bg_ex.jpg", 750/2, 500/2);  //750/2, 500/2, 740/2,480/2
			...
			var _homeSprite = createSprite("bg_ex.jpg", 750/2, 650/2);  //550/2
			_homeSprite.p.scale = 1.5; //2
