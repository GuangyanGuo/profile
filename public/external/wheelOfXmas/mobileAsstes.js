...
lib.ssMetadata = [
		{name:"mobileAsstes_atlas_", frames: [[1004,1608,78,59],[0,402,600,400],[0,0,600,400],[0,804,600,400],[0,1206,600,400],[0,1608,600,400],[602,0,600,400],[602,402,600,400],[602,1608,400,400],[602,804,600,400],[602,1206,600,400]]}
];
...
(lib.arrow_sm = function() {
	this.spriteSheet = ss["mobileAsstes_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib.mobileAsstes = function(mode,startPosition,loop) {
	...
	// middle_spin_button
	this.instance_1 = new lib.wheel_top_big_no_arrow();
	this.instance_1.parent = this;

	this.instance_2 = new lib.line_glow_big();
	this.instance_2.parent = this;
	this.instance_2.setTransform(1,0);

	this.instance_3 = new lib.bell();
	this.instance_3.parent = this;
	this.instance_3.setTransform(0,1);

	this.instance_4 = new lib.gift_glow();
	this.instance_4.parent = this;
	this.instance_4.setTransform(229.3,-153.5,1,1,45);

	this.instance_5 = new lib.holly();
	this.instance_5.parent = this;
	this.instance_5.setTransform(653.6,126.9,1,1,135);

	this.instance_6 = new lib.gingerbreadman();
	this.instance_6.parent = this;
	this.instance_6.setTransform(600.3,399.1,1,1,-180);

	this.instance_7 = new lib.tree();
	this.instance_7.parent = this;
	this.instance_7.setTransform(100,498,1,1,-90);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1}]}).to({state:[{t:this.instance_1}]},63).to({state:[{t:this.instance_1}]},41).to({state:[{t:this.instance_3},{t:this.instance_2,p:{x:1}}]},37).to({state:[{t:this.instance_1}]},16).to({state:[{t:this.instance_2,p:{x:1}},{t:this.instance_4}]},37).to({state:[{t:this.instance_1}]},16).to({state:[{t:this.instance_2,p:{x:0}},{t:this.instance_5}]},37).to({state:[{t:this.instance_1}]},16).to({state:[{t:this.instance_2,p:{x:0}},{t:this.instance_6}]},37).to({state:[{t:this.instance_1}]},16).to({state:[{t:this.instance_2,p:{x:0}},{t:this.instance_7}]},37).to({state:[{t:this.instance_1}]},16).to({state:[{t:this.instance_1}]},37).to({state:[{t:this.instance_1}]},16).to({state:[{t:this.instance_1}]},53).wait(53));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(104).to({_off:true},37).wait(16).to({_off:false},0).to({_off:true},37).wait(16).to({_off:false},0).to({_off:true},37).wait(16).to({_off:false},0).to({_off:true},37).wait(16).to({_off:false},0).to({_off:true},37).wait(16).to({_off:false},0).wait(159));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({_off:true},14).wait(121).to({_off:false,y:170},0).to({_off:true},22).wait(31).to({_off:false},0).to({_off:true},22).wait(31).to({_off:false,y:167},0).to({_off:true},22).wait(31).to({_off:false},0).to({_off:true},22).wait(31).to({_off:false},0).to({_off:true},22).wait(31).to({_off:false,y:169},0).to({_off:true},6).wait(47).to({_off:false},0).to({_off:true},6).wait(47).to({_off:false},0).to({_off:true},6).wait(16));
...
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/mobileAsstes_atlas_.png", id:"mobileAsstes_atlas_"}
	],
	preloads: []
};
